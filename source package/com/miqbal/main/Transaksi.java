 ...
 */
package com.miqbal.main;

import com.miqbal.xxx.comboModel;
import com.miqbal.xxx.itemsClass;
import com.miqbal.xxx.tableModel;
import com.miqbal.xxx.xxTransaksi;
...
public class Transaksi extends javax.swing.JFrame {
    ...
    private ArrayList<itemsClass> cart = new ArrayList<>(); // variabel cart untuk menyimpan masing-masing transaksi item
    ...
    public Transaksi() {
        ...
        this.cbModel = new DefaultComboBoxModel<>(comboModel.getNamaItem().toArray()); // untuk mengatur combo item
    ...
    private Object[] addItem(String nama, int jumlah){
        ...
        for (int i = 0; i < items.getNamaItem().size(); i++) {
            if(nama.equalsIgnoreCase(items.getNamaItem().get(i))){
                harga = items.getHargaItem().get(i);
            }
        }
        Object[] object = {
            nama,
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            for (int i = 0; i < tbModel.getRowCount(); i++) {                   
                ...
                int jumlah = new Integer(tbModel.getValueAt(i, 2).toString());
                this.cart.add(new itemsClass(nama, harga, jumlah));
            }
            xxTransaksi Trx = new xxTransaksi(this.code, this.cart);
            StringBuilder str = new StringBuilder();
            str.append(Trx.Detail());
